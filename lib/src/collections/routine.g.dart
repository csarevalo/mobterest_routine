...
void _routineSerialize(
  ...
  writer.writeDateTime(offsets[0], object.start);
...
Routine _routineDeserialize(
  ...
  object.id = id;
  object.start = reader.readDateTime(offsets[0]);
...
extension RoutineQueryWhereSort on QueryBuilder<Routine, Routine, QWhere> {
  ...
  QueryBuilder<Routine, Routine, QAfterWhere> anyStart() {
    return QueryBuilder.apply(this, (query) {
...
extension RoutineQueryWhere on QueryBuilder<Routine, Routine, QWhereClause> {
  ...
  QueryBuilder<Routine, Routine, QAfterWhereClause> startEqualTo(
      DateTime start) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Routine, Routine, QAfterWhereClause> startNotEqualTo(
      DateTime start) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Routine, Routine, QAfterWhereClause> startGreaterThan(
    DateTime start, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Routine, Routine, QAfterWhereClause> startLessThan(
    DateTime start, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Routine, Routine, QAfterWhereClause> startBetween(
    DateTime lowerStart,
    DateTime upperStart, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension RoutineQueryFilter
  ...
  QueryBuilder<Routine, Routine, QAfterFilterCondition> startEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'start',
  ...
  QueryBuilder<Routine, Routine, QAfterFilterCondition> startGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Routine, Routine, QAfterFilterCondition> startLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Routine, Routine, QAfterFilterCondition> startBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension RoutineQuerySortBy on QueryBuilder<Routine, Routine, QSortBy> {
  QueryBuilder<Routine, Routine, QAfterSortBy> sortByStart() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'start', Sort.asc);
    });
  }

  QueryBuilder<Routine, Routine, QAfterSortBy> sortByStartDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension RoutineQuerySortThenBy
  ...
  QueryBuilder<Routine, Routine, QAfterSortBy> thenByStart() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'start', Sort.asc);
    });
  }

  QueryBuilder<Routine, Routine, QAfterSortBy> thenByStartDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'start', Sort.desc);
    });
  }
...
extension RoutineQueryWhereDistinct
  ...
  QueryBuilder<Routine, Routine, QDistinct> distinctByStart() {
    return QueryBuilder.apply(this, (query) {
...
extension RoutineQueryProperty
  ...
  QueryBuilder<Routine, DateTime, QQueryOperations> startProperty() {
    return QueryBuilder.apply(this, (query) {
