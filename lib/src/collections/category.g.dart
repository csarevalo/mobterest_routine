...
extension CategoryQueryLinks
    on QueryBuilder<Category, Category, QFilterCondition> {
  QueryBuilder<Category, Category, QAfterFilterCondition> routines(
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> routinesLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> routinesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'routines', 0, true, 0, true);
    });
  }

  QueryBuilder<Category, Category, QAfterFilterCondition> routinesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> routinesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
